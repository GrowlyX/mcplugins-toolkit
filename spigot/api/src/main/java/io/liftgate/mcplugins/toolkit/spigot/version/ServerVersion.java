...
public enum ServerVersion {
    ...
    private static ServerVersion getVersionNoCache() {
        ...
        ServerVersion fallbackVersion = ServerVersion.v_1_7_10;
        try {
        ...
        Bukkit.getLogger().warning("Your server software is preventing us from checking the server version. This is what we found: " + Bukkit.getBukkitVersion() + ". We will assume the server version is " + fallbackVersion.name() + "...");
